...
Welcome! We are glad that you want to contribute to our CoHDI project! 💖
...
First, though, it is important that you read the [CODE-OF-CONDCT.md](https://github.com/cncf/foundation/blob/main/code-of-conduct.md).
